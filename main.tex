...
All calculations were performed using open-source Python code available at \url{https://github.com/motrosov/svls-v2.1}. The repository includes:
...
A Docker container with all dependencies is provided for exact reproduction of results. The analysis pipeline can be executed with a single command: \texttt{docker run motrosov/svls-v2.1}.
...
This research made use of the ATNF Pulsar Catalogue \citep{Manchester2005} and CHIME/FRB data \citep{CHIME2022}. Code and data are available at \url{https://github.com/motrosov/svls-v2.1}.
